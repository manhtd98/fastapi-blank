...
from fastf.db.dependencies import get_db_session
from fastf.db.utils import create_database, drop_database
from fastf.services.rabbit.dependencies import get_rmq_channel_pool
from fastf.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from fastf.services.redis.dependency import get_redis_pool
from fastf.settings import settings
from fastf.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from fastf.db.meta import meta  # noqa: WPS433
    from fastf.db.models import load_all_models  # noqa: WPS433
